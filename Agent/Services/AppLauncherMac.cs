...
namespace Remotely.Agent.Services
{
    public class AppLauncherMac : IAppLauncher
    {
        ...
        {
            await hubConnection.SendAsync("DisplayMessage", "Fonctionnalité en cours de développement.", "Cette fonctionnalité est en cours de développement.", "bg-warning", requesterID);
            return 0;
        }
